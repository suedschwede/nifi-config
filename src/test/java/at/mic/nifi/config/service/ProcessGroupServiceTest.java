...
import at.mic.nifi.config.service.ConnectionService;
...
public class ProcessGroupServiceTest {
    ...
    public void deleteTest() throws ApiException, IOException, URISyntaxException {
        ...
        when(processGroupsApiMock.removeProcessGroup(eq("123"), any(), any(), true)).thenReturn(processGroupEntity);
        ...
        verify(processGroupsApiMock).removeProcessGroup(eq("123"), any(), any(), true);
    ...
    public void deleteExternalConnectionTest() throws ApiException, IOException, URISyntaxException {
        ...
        when(processGroupsApiMock.removeProcessGroup(eq("123"), any(), any(), true))
        ...
        verify(processGroupsApiMock, times(2)).removeProcessGroup(eq("123"), any(), any(), true);
