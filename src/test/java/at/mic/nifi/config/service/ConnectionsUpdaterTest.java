...
import static at.mic.nifi.config.service.TestUtils.createConnection;
import static at.mic.nifi.config.service.TestUtils.createConnectionEntity;
...
public class ConnectionsUpdaterTest {
    ...
    @Test
    public void shouldThrowExceptionWhenConfigurationNotFound() throws ApiException {
