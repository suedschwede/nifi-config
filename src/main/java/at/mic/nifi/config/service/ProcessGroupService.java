...
public class ProcessGroupService {
     ...
     * @throws ApiException 
     */
    public List<Set<?>> reorder(ProcessGroupFlowDTO processGroupFlow) throws ApiException {
    ...
    public void delete(String processGroupId) {
        FunctionUtils.runWhile(() -> {
            ...
            try {
                ...
                processGroupToRemove = processGroupsApi.removeProcessGroup(processGroupId, processGroupEntity.getRevision().getVersion().toString(), null, true);
